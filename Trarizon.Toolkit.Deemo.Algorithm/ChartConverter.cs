...
public static class ChartConverter
{
        ...
        int? randomSeed = null)
    {
        ...
        var notes = chart.Notes.Where(n => n.IsVisible).PopFirst(out var prevNote);
    ...
    public static void Meiwaku(this Chart chart)
    {
        foreach (var note in chart.Notes) {
            if (note.IsVisible && Random.Shared.Next(2) == 0)
